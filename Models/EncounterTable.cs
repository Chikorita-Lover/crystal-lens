...
{
    internal record EncounterTable<K>(Dictionary<K, EncounterSet> EncounterSets) where K : notnull
    {
        ...
        public static EncounterTable<DayTime> ReadAssembly(Queue<ASMCommand> commands)
        {
